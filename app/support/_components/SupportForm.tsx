  ...
  const content = {
    fa: {
      ...
      validation: {
        ...
        nameMaxLength: "نام نباید بیشتر از ۱۰۰ کاراکتر باشد",
        emailRequired: "ایمیل الزامی است",
        emailInvalid: "ایمیل معتبر نیست",
        emailMaxLength: "ایمیل نباید بیشتر از ۱۰۰ کاراکتر باشد",
        subjectRequired: "موضوع الزامی است",
        subjectMaxLength: "موضوع نباید بیشتر از ۱۵۰ کاراکتر باشد",
    ...
    en: {
      ...
      validation: {
        ...
        subjectMaxLength: "Subject must be less than 150 characters",
