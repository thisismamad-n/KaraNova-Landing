  ...
  const content = {
    fa: {
      ...
      validation: {
        ...
        nameMax: "نام باید کمتر از ۱۰۰ کاراکتر باشد",
        emailRequired: "ایمیل الزامی است",
        emailInvalid: "ایمیل معتبر نیست",
        emailMax: "ایمیل باید کمتر از ۱۰۰ کاراکتر باشد",
        phoneInvalid: "شماره تلفن معتبر نیست",
        phoneMax: "شماره تلفن باید کمتر از ۲۰ کاراکتر باشد",
        companyMax: "نام شرکت باید کمتر از ۱۰۰ کاراکتر باشد",
        subjectMin: "موضوع باید حداقل ۳ کاراکتر باشد",
        subjectMax: "موضوع باید کمتر از ۱۰۰ کاراکتر باشد",
        messageMin: "پیام باید حداقل ۱۰ کاراکتر باشد",
        messageMax: "پیام باید کمتر از ۱۰۰۰ کاراکتر باشد",
    ...
    en: {
      ...
      validation: {
        ...
        companyMax: "Company must be less than 100 characters",
    ...
    try {
      ...
      if (error instanceof z.ZodError) {
        ...
        error.issues.forEach((err) => {
          ...
          } else if (field === "name" && err.message.includes("less than 100")) {
            newErrors[field] = currentContent.validation.nameMax;
          } else if (field === "email" && err.message.includes("less than 100")) {
          ...
          } else if (field === "phone" && err.message.includes("less than 20")) {
          ...
          } else if (field === "company" && err.message.includes("less than 100")) {
          ...
          } else if (field === "subject" && err.message.includes("less than 100")) {
          ...
          } else if (field === "message" && err.message.includes("less than 1000")) {
