  ...
  const content = {
    fa: {
      ...
      validation: {
        ...
        emailMax: "ایمیل باید حداکثر ۱۰۰ کاراکتر باشد",
        ...
        subjectMax: "موضوع باید حداکثر ۱۰۰ کاراکتر باشد",
        messageMin: "پیام باید حداقل ۱۰ کاراکتر باشد",
        messageMax: "پیام باید حداکثر ۱۰۰۰ کاراکتر باشد",
    ...
    try {
      ...
      if (error instanceof z.ZodError) {
        ...
        error.issues.forEach((err) => {
          ...
          } else if (field === "email" && err.message.includes("at most 100")) {
          ...
          } else if (field === "subject" && err.message.includes("at most 100")) {
          ...
          } else if (field === "message" && err.message.includes("at most 1000")) {
