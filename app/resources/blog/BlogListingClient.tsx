...
// Get unique categories outside component to avoid recreation on every render
const categories = Array.from(new Set(mockBlogs.map((blog) => blog.category))) as BlogCategory[];

// Bilingual content static outside component to avoid recreation on every render
const content = {
  en: {
    hero: {
      title: "Blog",
