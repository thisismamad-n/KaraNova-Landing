          ...
          {currentContent.faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full px-6 py-5 flex items-center justify-between gap-4 text-right focus-visible:outline-none focus-visible:bg-slate-800/60 transition-colors rounded-xl"
              >
