          ...
          {currentContent.faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full px-6 py-5 flex items-center justify-between gap-4 text-right rounded-t-2xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
              >
